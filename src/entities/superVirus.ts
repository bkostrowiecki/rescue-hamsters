...
export class SuperVirus extends VirusBase {
    game: Phaser.Game;
    heart: Heart;
    ...
    constructor(game: Phaser.Game, heart: Heart) {
        super(game, -2000, -200, 'superVirus', 1);

        this.game = game;
        this.heart = heart;

        this.virusState = VirusState.Free;
        ...
        this.attackTimer.loop(2500, this.attackTick.bind(this), this);
    ...
    overlapHandler() {
        ...
        this.game.time.events.add(this.randomGenerator.getRandomInteger(200, 1000), () => {
